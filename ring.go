...
type RingBuffer struct {
	_padding0      [8]uint64 // nolint: unused // cache line padding
	queue          uint64
	_padding1      [8]uint64 // nolint: unused // cache line padding
	dequeue        uint64
	_padding2      [8]uint64 // nolint: unused // cache line padding
